...
#define DEFINE_CONCRETE_BIN_OP_MULTIWORD_add2_DUAL(name, op)                   \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_add2(32, name, op)                          \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_add2(64, name, op)

#define DEFINE_CONCRETE_BIN_OP_MULTIWORD_sub2(bits, name, op)                  \
  static inline void __qce_concrete_bv##bits##_##name(                         \
      int##bits##_t lhs_low, int##bits##_t lhs_high,                           \
      int##bits##_t rhs_low, int##bits##_t rhs_high,                           \
      int##bits##_t *res_low, int##bits##_t *res_high) {                       \
...
#define DEFINE_CONCRETE_BIN_OP_MULTIWORD_sub2_DUAL(name, op)                   \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_sub2(32, name, op)                          \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_sub2(64, name, op)

#define DEFINE_CONCRETE_BIN_OP_MULTIWORD_muls2(bits, name, op)                 \
  static inline void __qce_concrete_bv##bits##_##name(                         \
      int##bits##_t lhs, int##bits##_t rhs,                                    \
      int##bits##_t *res_low, int##bits##_t *res_high) {                       \
    union {                                                                    \
...
#define DEFINE_CONCRETE_BIN_OP_MULTIWORD_muls2_DUAL(name, op)                  \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_muls2(32, name, op)                         \
  DEFINE_CONCRETE_BIN_OP_MULTIWORD_muls2(64, name, op)

DEFINE_CONCRETE_BIN_OP_MULTIWORD_add2_DUAL(add2, +)
DEFINE_CONCRETE_BIN_OP_MULTIWORD_sub2_DUAL(sub2, -)
...
#define DEFINE_EXPR_BIN_OP_MULTIWORD(bits, name)                               \
  static inline void qce_expr_##name##_i##bits(                                \
...
#define DEFINE_EXPR_BIN_OP_MULTIWORD_DUAL(name)                                \
  DEFINE_EXPR_BIN_OP_MULTIWORD(32, name)                                       \
  DEFINE_EXPR_BIN_OP_MULTIWORD(64, name)

#define DEFINE_EXPR_BIN_OP_MULTIWORD2(bits, name)                              \
  static inline void qce_expr_##name##_i##bits(                                \
...
#define DEFINE_EXPR_BIN_OP_MULTIWORD2_DUAL(name)                               \
  DEFINE_EXPR_BIN_OP_MULTIWORD2(32, name)                                      \
  DEFINE_EXPR_BIN_OP_MULTIWORD2(64, name)
...
DEFINE_EXPR_BIN_OP_MULTIWORD_DUAL(add2)
DEFINE_EXPR_BIN_OP_MULTIWORD_DUAL(sub2)
// DEFINE_EXPR_BIN_OP_MULTIWORD2_DUAL(mulu2)
DEFINE_EXPR_BIN_OP_MULTIWORD2_DUAL(muls2)
