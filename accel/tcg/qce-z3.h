...
#ifndef QCE_RELEASE
static inline void __qce_smt_z3_type_check_i32(SolverZ3 *solver, Z3_ast expr) {
...
static inline void __qce_smt_z3_type_check_i64(SolverZ3 *solver, Z3_ast expr) {
  Z3_sort sort = Z3_get_sort(solver->ctx, expr);
  if (Z3_get_sort_kind(solver->ctx, sort) != Z3_BV_SORT) {
...
#else
#define __qce_smt_z3_type_check_i32(solver, expr)
#define __qce_smt_z3_type_check_i64(solver, expr)
#endif
...
static inline bool qce_smt_z3_probe_bv32(SolverZ3 *solver, Z3_ast expr,
                                         int32_t *val) {
  __qce_smt_z3_type_check_i32(solver, expr);
...
static inline bool qce_smt_z3_probe_bv64(SolverZ3 *solver, Z3_ast expr,
                                         int64_t *val) {
  __qce_smt_z3_type_check_i64(solver, expr);
...
static inline Z3_ast qce_smt_z3_bv64_concat(SolverZ3 *solver, Z3_ast h,
                                            Z3_ast l) {
  __qce_smt_z3_type_check_i32(solver, h);
  __qce_smt_z3_type_check_i32(solver, l);
